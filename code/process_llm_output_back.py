...
def main(args):
    ...
    if args.output_path_json is None:
        ...
        output_path_json = qa_pred_path.parent.parent / f'data_generate_{args.question_num}_select_{args.qa_select_num}_back.json'
    ...
    if args.output_path_json is None:
        output_path_csv = qa_pred_path.parent.parent / f'data_generate_{args.question_num}_select_{args.qa_select_num}_back.csv'
    else:
